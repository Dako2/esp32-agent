...
#define LED_LEDC_CHANNEL    0      // Choose a LEDC channel (0-15)
#define LED_LEDC_TIMER      LEDC_TIMER_0
#define LED_LEDC_BASE_FREQ  5000   // Frequency in Hz
#define LED_LEDC_RESOLUTION 8      // Resolution in bits

void setupLedFlash(int pin) 
{
    // Initialize the LEDC channel with the specified parameters
    ledcSetup(LED_LEDC_CHANNEL, LED_LEDC_BASE_FREQ, LED_LEDC_RESOLUTION);
    
    // Attach the GPIO pin to the LEDC channel
    ledcAttachPin(pin, LED_LEDC_CHANNEL);
    
    // Optionally, set an initial duty cycle (e.g., LED off)
    ledcWrite(LED_LEDC_CHANNEL, 0);
    
    log_i("LED Flash initialized on GPIO %d with channel %d, frequency %d Hz, resolution %d bits", 
          pin, LED_LEDC_CHANNEL, LED_LEDC_BASE_FREQ, LED_LEDC_RESOLUTION);
}
